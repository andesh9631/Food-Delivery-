if (process.env.NODE_ENV !== "production") {
  ...
  console.log(process.env.ATLUS_URI)
const mongoose = require("mongoose");
const FoodData = require("../models/foodData");
const FoodCategory = require("../models/foodCategory");

const connectMongo = async () => {
  await mongoose.connect(`mongodb+srv://gofood:Andesh963p@cluster0.kr0vuac.mongodb.net/gofoodmern?retryWrites=true&w=majority`, {
...
const seedDB = async () => {
  ...
  await FoodData.insertMany(foodData);
  await FoodCategory.insertMany(foodCate);
};
